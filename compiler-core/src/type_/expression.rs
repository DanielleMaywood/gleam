...
pub struct FunctionDefinition {
    ...
    /// The function has @external(chez, "...", "...")
    pub has_chez_external: bool,
}
...
impl FunctionDefinition {
    pub fn has_external_for_target(&self, target: Target) -> bool {
        match target {
            ...
            Target::Chez => self.has_chez_external,
        }
    }
}
...
impl Implementations {
    ...
    pub fn update_from_use(
        ...
        self.can_run_on_chez =
            *has_chez_external || (self.can_run_on_chez && (*gleam || *other_can_run_on_chez));
    ...
    pub fn supports(&self, target: Target) -> bool {
        self.gleam
            || match target {
                ...
                Target::Chez => self.can_run_on_chez,
            }
    }
}
